# Код для добавления в app/routers/dentists.py
# Добавьте этот endpoint В КОНЕЦ файла, после функции update_dentist_profile()
...
def get_all_dentists(
    ...
    # Get all dentist profiles with their user info
    ...
    for profile in dentists:
        ...
        # Calculate statistics for each dentist
